...
from generator import print_exam
...
if not st.session_state['logged_in']:
    ...
    if app_choice == "Home 🏡":
        ...
        st.subheader("Empowering English Educators")
        st.write("Welcome, dedicated educators! Our Exam Creation Lab is specifically designed to assist you in crafting comprehensive English exams. With our platform, you can easily generate various types of questions that cater to all aspects of language learning.")
